...
! of structures with N faces. Uses the .b.flg format as basic instrument.    !!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
USE tools_read                                                               !!!
USE tools_adim                                                               !!!
USE tools_conv                                                               !!!
...
INTEGER,ALLOCATABLE:: flag0(:,:),nface0(:)   !!!
...
IF(nf0.eq.0) CALL write_graphene('6',1,1,0,0,1)                            !!!
! Generation size                                                            !!!
...
DO isys=1,nsys_p                                                             !!!
  ...
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  CALL read_flg(nf0,ne0,nv0,nflags0,nface0,flag0,filename)
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  init_flag0=0                                                               !!!
  DO i=1,nflags0                                                             !!!
    IF((flag0(i,0).eq.1).AND.(init_flag0(flag0(i,1)).eq.0))THEN          !!!
  ...
  DO i=1,nf0                                                                 !!!
    ...
    DO j=1,nface0(i)                                                         !!!
      ...
      flag_a=flag0(flag_a,-3)                                           !!!
      flag_a=flag0(flag_a,-2)                                           !!!
    END DO                                                                   !!!
  END DO                                                                     !!!
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ! Getting maps for the parent system                                       !!!
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  
  CALL flg2map(nflags0,flag0,nf0,nface0,nmaps,maps,maps_nfixed)
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  DO f0=fp,nf0!iif,iif                                                       !!!
    ...
    DO ie1=1,nface0(f0) ! ie1 gives E1                                       !!!
      ...
      ! Border flags                                                         !!!
      flag_1a=flag_a                                                         !!!
      flag_1b=flag0(flag_1a,-1)                                         !!!
      ! F1/E1/V1 from the current flag_a                                     !!!
      f1=flag0(flag0(flag_a,-1),1)                                      !!!
      e1=flag0(flag_a,2)                                                     !!!
      v1=flag0(flag_a,3)                                                     !!!
...
!         IF(e1.ne.e2) print*,'diffe'
        ...
        DO                                                                   !!!
          ...
          flag_c=flag0(flag_c,-3)                                       !!!
          ! Correcting face for inherited flag                               !!!
          flag1(flag_c,1)=f3                                                 !!!
          ! Move flag_c one edge ahead (part 2 - e-swap)                     !!!
          flag_c=flag0(flag_c,-2)                                       !!!
        END DO                                                               !!!
        ...
        flag1(flag_1a,-3)=nflags0+1
        flag1(nflags0+1,-3)=flag_1a
        flag1(nflags0+1,-2)=nflags0+2
        flag1(nflags0+1,-1)=nflags0+6
        flag1(flag_1b,-3)=nflags0+6
        flag1(nflags0+6,-3)=flag_1b
        flag1(nflags0+6,-2)=nflags0+5
        flag1(nflags0+6,-1)=nflags0+1        
        ! V3-to-V6 (it works as V4-V6 if e1=e2)
        flag1(flag_3a,-3)=nflags0+10
        flag1(nflags0+10,-3)=flag_3a
        flag1(nflags0+10,-2)=nflags0+9
        flag1(nflags0+10,-1)=nflags0+11
        flag1(flag_3b,-3)=nflags0+11
        flag1(nflags0+11,-3)=flag_3b
        flag1(nflags0+11,-2)=nflags0+12
        flag1(nflags0+11,-1)=nflags0+10
        ! V4-to-V5 (only for e1/=e2)
        IF(e1.ne.e2)THEN
          flag1(flag_4a,-3)=nflags0+4
          flag1(nflags0+4,-3)=flag_4a
          flag1(nflags0+4,-2)=nflags0+3
          flag1(nflags0+4,-1)=nflags0+5        
          flag1(flag_4b,-3)=nflags0+5
          flag1(nflags0+5,-3)=flag_4b
          flag1(nflags0+5,-2)=nflags0+6
          flag1(nflags0+5,-1)=nflags0+4
        END IF
        ! V2-to-V6 (only for e1/=e2)
        IF(e1.ne.e2)THEN
          flag1(flag_2a,-3)=nflags0+7
          flag1(nflags0+7,-3)=flag_2a
          flag1(nflags0+7,-2)=nflags0+8
          flag1(nflags0+7,-1)=nflags0+12        
          flag1(flag_2b,-3)=nflags0+12
          flag1(nflags0+12,-3)=flag_2b
          flag1(nflags0+12,-2)=nflags0+11
          flag1(nflags0+12,-1)=nflags0+7        
        END IF
        ! V5-to-V6 (through E0)
        flag1(nflags0+2,-3)=nflags0+8
        flag1(nflags0+2,-2)=nflags0+1
        flag1(nflags0+2,-1)=nflags0+3        
        flag1(nflags0+8,-3)=nflags0+2
        flag1(nflags0+8,-2)=nflags0+7
        flag1(nflags0+8,-1)=nflags0+9        
        flag1(nflags0+3,-3)=nflags0+9
        flag1(nflags0+3,-2)=nflags0+4
        flag1(nflags0+3,-1)=nflags0+2        
        flag1(nflags0+9,-3)=nflags0+3
        flag1(nflags0+9,-2)=nflags0+10
        flag1(nflags0+9,-1)=nflags0+8        
        IF(e1.eq.e2)THEN
          ! V5-to-V6 (through E3)
          flag1(nflags0+4,-3)=nflags0+12
          flag1(nflags0+4,-2)=nflags0+3
          flag1(nflags0+4,-1)=nflags0+5        
          flag1(nflags0+5,-3)=nflags0+7
          flag1(nflags0+5,-2)=nflags0+6
          flag1(nflags0+5,-1)=nflags0+4

          flag1(nflags0+7,-3)=nflags0+5
          flag1(nflags0+7,-2)=nflags0+8
          flag1(nflags0+7,-1)=nflags0+12        
          flag1(nflags0+12,-3)=nflags0+4
          flag1(nflags0+12,-2)=nflags0+11
          flag1(nflags0+12,-1)=nflags0+7
        ...
        !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                             !!!       
        CALL face_size_from_flag(nface1(f0),flag_1a,nflags1,flag1)
        CALL face_size_from_flag(nface1(f3),flag_4a,nflags1,flag1)
        IF((f1.ne.f0).AND.(f1.ne.f3)) CALL face_size_from_flag(nface1(f1),flag_1b,nflags1,flag1)
        IF((f2.ne.f0).AND.(f2.ne.f3).AND.(f2.ne.f1)) CALL face_size_from_flag(nface1(f2),flag_2b,nflags1,flag1)
        !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                             !!!
        ! flg to map                                                         !!!
        !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                             !!!
        CALL flg2map(nflags1,flag1,nf1,nface1,nmaps,maps,maps_nfixed)  ! alocs inside
        ntmaps=0                                                             !!!
        DO i=1,nmaps                                                         !!!
          IF(maps_nfixed(i).ne.0) CYCLE                                      !!!
          IF(flag1(1,0)*flag1(maps(i,1),0).eq.1) ntmaps=ntmaps+1     !!!
        END DO                                                               !!!
        ...
        DO                                                                   !!!
          ...
          IF(file_exist)THEN                                                 !!!
            ALLOCATE(nface2(nf1))                                                      !!!
            ALLOCATE(flag2(nflags1,-3:3))     !!!          
            ! Get previous flag graph                                        !!!          
            CALL read_flg(nf1,ne1,nv1,nflags1,nface2,flag2,trialfile)!!
            ! Compare with trial flag graph                                  !!!
            CALL check_equiv_fgraphs(nflags1,nf1,flag1,nface1, &
                                   & nflags1,nf1,flag2,nface2,same)
            DEALLOCATE(nface2,flag2)     !!!                                             
!             IF(.not.same) print*,TRIM(trialfile)
        ...
        IF(.not.same)THEN                                                    !!!
          ...
          ! Writing .b.flg                                                   !!!
          !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                           !!!
          CALL write_flg_bin(nf1,ne1,nv1,nflags1,nface1,flag1,tmpfile)
          !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                           !!!
          ! Writing .anc                                                     !!!
          !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                           !!!
          CALL write_anc(f0,flag_1a,flag_3a,tmpfile,filename)                        !!!
        END IF                                                               !!!
        DEALLOCATE(nface1)                                                         !!!
        DEALLOCATE(flag1)                                  !!!          
      END DO                                                                 !!!
