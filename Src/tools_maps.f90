...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
SUBROUTINE creating_maps(nflags,flag,nf,nface,nmaps,maps)         !!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
IMPLICIT NONE                                                                !!!
INTEGER:: i,j,nmaps,nflags,flag(nflags,-3:3),tmpsize         !!!
...
DO j=1,nflags                                                                !!!
  ...
  CALL check_map(nflags,nf,flag,nface, &                          !!!
             &   nflags,nf,flag,nface,i,j,map,mapa)               !!!
  IF(.not.map) CYCLE                                                         !!!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
SUBROUTINE map_types(nflags,flag,nrotmaps,nmirmaps,nglimaps,ntramaps,nmaps,maps,maps_nfixed)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
IMPLICIT NONE                                                                !!!
INTEGER:: nflags,flag(nflags,-3:3),nrotmaps,nmirmaps,nglimaps,ntramaps      !!!
...
DO i=1,nmaps                                                                 !!!
  ...
  IF(maps_nfixed(i).eq.0)THEN                                                !!!
    IF(flag(1,0)*flag(maps(i,1),0).eq.1) ntramaps=ntramaps+1         !!!
    IF(flag(1,0)*flag(maps(i,1),0).eq.-1) nglimaps=nglimaps+1        !!!
  END IF                                                                     !!!
END DO                                                                       !!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
SUBROUTINE check_equiv_fgraphs(nflags1,nf1,flag1,nface1, &       !!!
                            &  nflags2,nf2,flag2,nface2,same)!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
IMPLICIT NONE                                                                !!!
INTEGER:: nflags1,nf1,flag1(nflags1,-3:3),nface1(nf1)     !!!
INTEGER:: nflags2,nf2,flag2(nflags2,-3:3),nface2(nf2)     !!!
INTEGER:: i,j                                                                !!!
LOGICAL:: map,same                                                           !!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
same=.false.                                                                 !!!
...
DO j=1,nflags2                                                               !!!
  ! Cheking for a map starting with i->j                                     !!!
  CALL check_map(nflags1,nf1,flag1,nface1, &                     !!!
              &  nflags2,nf2,flag2,nface2,i,j,map)               !!!
  IF(map)THEN                                                                !!!
    same=.true.                                                              !!!
    RETURN                                                                   !!!
  END IF                                                                     !!!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
SUBROUTINE check_map(nflags1,nf1,flag1,nface1, &                 !!!
                    &   nflags2,nf2,flag2,nface2,i,j,map,mapping)!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
IMPLICIT NONE                                                                !!!
INTEGER:: i,j,l,m,p,inext,jnext,nflags1,nflags2,nf1,nf2,f1,f2,e1,e2,v1,v2    !!!
INTEGER:: flag1(nflags1,-3:3),nface1(nf1)                !!!
INTEGER:: flag2(nflags2,-3:3),nface2(nf2)                !!!
...
CALL same_local(nflags1,nf1,flag1,nface1, &                      !!!
             &  nflags2,nf2,flag2,nface2,i,j,same)               !!!
...
DO p=1,nflags1-1                                                             !!!
  ...
  CALL same_local(nflags1,nf1,flag1,nface1, &                    !!!
             &    nflags2,nf2,flag2,nface2,inext,jnext,same)     !!!
  IF(same)THEN                                                               !!!
  ...
  DO m=1,nflags1                                                             !!!
    IF(ok(m))THEN                                                            !!!
      mapa_m=mapa(m)                                                         !!!
      DO l=1,3                                                               !!!
        IF(.not.ok(flag1(m,-l)))THEN                                    !!!
          candidate=.true.                                                   !!!
          inext=flag1(m,-l)                                             !!!
          jnext=flag2(mapa_m,-l)                                        !!!
          EXIT                                                               !!!
        END IF                                                               !!!
      END DO                                                                 !!!
    END IF                                                                   !!!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
SUBROUTINE same_local(nflags1,nf1,flag1,nface1, &                !!!
                  &   nflags2,nf2,flag2,nface2,i,j,same)         !!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
IMPLICIT NONE                                                                !!!
...
IF(nface1(flag1(i,1)).eq.nface2(flag2(j,1)))THEN                             !!!
  ...
  IF(nface1(flag1(ii,1)).eq.nface2(flag2(jj,1)))THEN                         !!!
    ...
    iii=flag1(flag1(i,-2),-1)                                      !!!
    jjj=flag2(flag2(j,-2),-1)                                      !!!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
SUBROUTINE flg2map(nflags,flag,nf,nface,nmaps,maps,maps_nfixed,m11,m22)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
IMPLICIT NONE                                                                !!!
INTEGER:: flag(nflags,-3:3),nmaps       !!!
INTEGER:: nface(nf),nf,nflags                                                !!!
INTEGER,ALLOCATABLE:: maps(:,:),maps_nfixed(:),m2(:,:),m1(:,:)               !!!
INTEGER,ALLOCATABLE,INTENT(OUT),OPTIONAL:: m11(:,:),m22(:,:)                 !!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! First Neighbors                                                            !!!
CALL first_neighbors(nflags,flag,m2)                                   !!!
! Second Neighbors                                                           !!!
CALL second_neighbors(nflags,flag,m2,m1)                          !!!
! Creating the maps (allocations inside)                                     !!!
CALL creating_maps(nflags,flag,nf,nface,nmaps,maps)               !!!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
SUBROUTINE first_neighbors(nflags,flag,m2)                             !!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
IMPLICIT NONE                                                                !!!
INTEGER,ALLOCATABLE,INTENT(OUT):: m2(:,:)                                    !!!
INTEGER:: i,j,l,nflags,flag(nflags,-3:3)                                  !!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
SUBROUTINE second_neighbors(nflags,flag,m2,m1)                    !!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
IMPLICIT NONE                                                                !!!
INTEGER,ALLOCATABLE,INTENT(OUT):: m1(:,:)                                    !!!
INTEGER:: i,j,nflags,flag(nflags,-3:3),m2(nflags,nflags)     !!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
DO i=1,nflags                                                                !!!
  DO j=i+1,nflags                                                            !!!
    IF(flag(i,1).eq.flag(j,1))THEN                                           !!!
      ...
      IF(flag(i,0)*flag(j,0).eq.-1) CYCLE                            !!!
      m1(i,j)=1                                                              !!!
      m1(j,i)=1                                                              !!!
      CYCLE                                                                  !!!
    END IF                                                                   !!!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
SUBROUTINE get_tramaps(nmaps,nflags,flag,maps,maps_nfixed,ntramaps,tmaps)!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
IMPLICIT NONE                                                                !!!
INTEGER:: nmaps,nflags,maps(nmaps,nflags),maps_nfixed(nmaps)                 !!!
INTEGER:: ntramaps,tmpsize,n,flag(nflags,-3:3)                              !!!
...
DO n=1,nmaps                                                                 !!!
  IF(maps_nfixed(n).eq.0)THEN                                                !!!
    IF(flag(1,0)*flag(maps(n,1),0).eq.1)THEN                         !!!
      ntramaps=ntramaps+1                                                    !!!
