...
PROGRAM fev2pov                                                              !!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! Tool for Embedding-Tensor to PovRay illustration of the cuboid structure.  !!!
...
DO i=1,nf                                                                    !!!
  WRITE(aux,'(I0)') i                                                        !!!
  OPEN(NEWUNIT=u,FILE=TRIM(ADJUSTL(filename))//'-f'//TRIM(ADJUSTL(aux))//'.pov')
  vloc(1)=10 ; vloc(2)=0.5*nv ; vloc(3)=0.5*ne                               !!!
  v_at(1)=0.0 ; v_at(2)=0.5*nv ; v_at(3)=0.5*ne                              !!!
  v_up=0.0D0 ; v_up(2)=4.0*nf+1.0                                            !!!
  v_rg=0.0D0 ; v_rg(1)=4.0*nf+1.0                                            !!!
  CALL pov_header(vloc,v_at,v_up,v_rg,vl,u)                                  !!!
  ! FEV tensor                                                               !!!
