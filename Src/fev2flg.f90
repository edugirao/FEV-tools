...
INTEGER,ALLOCATABLE:: flag_j(:,:)        !!!
INTEGER,ALLOCATABLE:: reduc_ev(:,:)                                          !!!
INTEGER,ALLOCATABLE:: flag_set(:,:,:)              !!!
...
DO i=1,ng                                                                    !!!
  ...
  DO j=1,i-1                                                                 !!!
    flag_j=flag_set(j,:,:)                                       !!!
    CALL check_equiv_fgraphs(nflags,nf,flag,nface, &              !!!
                           & nflags,nf,flag_j,nface,same)         !!!
    IF(same) EXIT                                                            !!!
  END DO                                                                     !!!
  IF(same) CYCLE                                                             !!!
  ig=ig+1                                                                    !!!
  ...
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!      
  CALL write_flg(nf,ne,nv,nflags,nface,flag,fileindex) !!!
END DO                                                                       !!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
END PROGRAM fev2flg                                                          !!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
