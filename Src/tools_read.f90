...
ELSE                                                                         !!!
  ...
  IF(have_file_f)THEN                                                        !!!
    ...
    READ(u,*) nface                                                          !!!
    DO i=1,nflags                                                            !!!
      READ(u,*) flag(i,:),neigh_flag(i,:),flag_color(i)                      !!!
    END DO                                                                   !!!
    CLOSE(UNIT=u)                                                            !!!
  ELSE                                                                       !!!
...
IF(have_file_b)THEN                                                          !!!
  OPEN(NEWUNIT=u,FILE=TRIM(ADJUSTL(filename))//'.b.fcs',FORM='UNFORMATTED')  !!!
  READ(u)  nf,ne,nv,nmax                                                     !!!
  ALLOCATE(f_in_f(nf,nmax),nface(nf))                                        !!!
  DO i=1,nf                                                                  !!!
    READ(u) nface(i)!,uneq_face(i)                                           !!!
    READ(u) f_in_f(i,1:nface(i))                                             !!!
    READ(u) !e_in_f(i,1:nface(i))                                            !!!
    READ(u) !v_in_f(i,1:nface(i))                                            !!!
    READ(u) !b_in_f(i,1:nface(i))                                            !!!
    READ(u) !u_in_f(i,1:nface(i))                                            !!!
  END DO                                                                     !!!
  CLOSE(UNIT=u)                                                              !!!
ELSE                                                                         !!!
  INQUIRE(FILE=TRIM(ADJUSTL(filename))//'.fcs',EXIST=have_file_f)            !!!
...
INTEGER,INTENT(OUT):: nface(nf),x_in_f(nf,nmax),y_in_f(nf,nmax)              !!!
INTEGER:: i,u                                                                !!!
CHARACTER(LEN=*),INTENT(IN):: filename                                       !!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
DO i=1,nf                                                                    !!!
  READ(u,*) nface(i)                                                         !!!
  READ(u,*) x_in_f(i,1:nface(i))                                             !!!
  READ(u,*) y_in_f(i,1:nface(i))                                             !!!
END DO                                                                       !!!
CLOSE(UNIT=u)                                                                !!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
OPEN(NEWUNIT=u,FILE='gensize'//TRIM(ADJUSTL(gensize_p)))                     !!!
READ(u,*) nsys_p                                                             !!!
CLOSE(UNIT=u)                                                                !!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
i0=2                                                                         !!!
DO i=nf,2,-1                                                                 !!!
  OPEN(NEWUNIT=u,FILE=TRIM(ADJUSTL(filename_list(i)))//'.anc')               !!!
  READ(u,*) filename_list(i-1)                                               !!!
  CLOSE(UNIT=u)                                                              !!!
